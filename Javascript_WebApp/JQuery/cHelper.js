...
/*
///// ฟังก์ชั้นดึง querystring
//GetQueryStringParams("typedealer")
*/
...
*/ 
function SetOptionList(fistElement,elemName, optionList) {
    try {
        $(elemName).append($('<option></option>').val('').html(fistElement));
...
function SetOptionListDdl($$thisElement, text, value) {
    $$thisElement.append("<option value='" + value + "'>" + text + "</option>");
} 
...
/// เช็คไม่ใช่ชื่อไทย 
//<input  onkeypress=" return fncNotThai(event);" maxlength="9" type="text">
